    ...
    <div class="modal-dialog">
        <div class="modal-content"
            ...
            <div class="modal-header" style="border-bottom: 1px solid #eee; padding: 20px 25px;">
                <h5 class="modal-title" id="importExcelModalLabel" style="font-size: 1.3rem; font-weight: 600;">Import
                    danh sách giảng viên từ Excel</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="importExcelForm" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 25px;">
                    <div class="mb-4">
                        <label for="excel_file" class="form-label" style="font-weight: 500;">Chọn file Excel <span
                                class="text-danger">*</span></label>
                        <input type="file" class="form-control" id="excel_file" name="excel_file" accept=".xlsx,.xls"
                            required style="border-radius: 8px; padding: 12px; border: 1px solid #ddd;">
                    ...
                    <div class="d-none" id="mappingSection">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <select class="form-select column-mapping" data-field="lecturer_code"
                                    data-required="true">
