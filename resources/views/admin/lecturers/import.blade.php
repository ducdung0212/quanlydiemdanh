<!-- Modal Import Excel -->
<div class="modal fade" id="importLecturerModal" tabindex="-1" aria-labelledby="importLecturerModalLabel" aria-hidden="true" data-bs-backdrop="false">
	<div class="modal-dialog">
		<div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.15);">
			<div class="modal-header" style="border-bottom: 1px solid #eee; padding: 20px 25px;">
				<h5 class="modal-title" id="importLecturerModalLabel" style="font-size: 1.3rem; font-weight: 600;">Import danh sách giảng viên từ Excel</h5>
			...
			<form id="importLecturerForm" enctype="multipart/form-data">
				<div class="modal-body" style="padding: 25px;">
					<div class="mb-4">
						...
						<input type="file" class="form-control" id="excel_file" name="excel_file" accept=".xlsx,.xls" required style="border-radius: 8px; padding: 12px; border: 1px solid #ddd;">
					...
					<div class="d-none" id="mappingSection">
						<div class="alert alert-secondary" role="alert">
							Chọn cột tương ứng cho từng trường. <strong>Mã giảng viên</strong> là bắt buộc.
						</div>
						<div class="row g-3">
							<div class="col-12">
							...
							<div class="col-12 col-md-6">
								...
								<select class="form-select column-mapping" data-field="faculty_code">
									<option value="">-- Chọn cột --</option>
								</select>
							</div>
							<div class="col-12 col-md-6">
				...
				<div class="modal-footer" style="border-top: 1px solid #eee; padding: 20px 25px;">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="border-radius: 8px; padding: 10px 20px; border: none;">Hủy</button>
					<button type="submit" class="btn btn-primary" id="btnImportLecturer" style="border-radius: 8px; padding: 10px 20px; background-color: #2377FC; border: none;">
