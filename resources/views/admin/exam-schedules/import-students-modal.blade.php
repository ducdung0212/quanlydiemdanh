                ...
                <div class="modal-body" style="padding: 25px;">
                    <div class="mb-4">
                        <label for="students_excel_file" class="form-label"
                            style="font-weight: 500; font-size: 1.1rem;">Chọn file Excel
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <select class="form-select form-select-lg column-mapping-students"
                                    data-field="student_code" data-required="true" style="font-size: 1.05rem;">
                                    <option value="">-- Chọn cột --</option>
                                </select>
                            </div>
                            <div class="col-12">
                                <label class="form-label" style="font-size: 1.1rem; font-weight: 500;">Họ tên</label>
                                <select class="form-select form-select-lg column-mapping-students"
                                    data-field="full_name" data-required="false" style="font-size: 1.05rem;">
                                    <option value="">-- Chọn cột --</option>
                                </select>
                            </div>
                            <div class="col-12">
                                <label class="form-label" style="font-size: 1.1rem; font-weight: 500;">Lớp</label>
                                <select class="form-select form-select-lg column-mapping-students"
                                    data-field="class_code" data-required="false" style="font-size: 1.05rem;">
                                    <option value="">-- Chọn cột --</option>
                                </select>
                            </div>
                        </div>
