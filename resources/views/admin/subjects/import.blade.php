    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.15);">
            <div class="modal-header" style="border-bottom: 1px solid #eee; padding: 20px 25px;">
                <h5 class="modal-title" id="importExcelModalLabel" style="font-size: 1.3rem; font-weight: 600;">Import danh sách môn học từ Excel</h5>
                ...
                <div class="modal-body" style="padding: 25px;">
                    ...
                    <div class="d-none" id="mappingSection">
                        <div class="alert alert-secondary" role="alert">
                            Chọn cột tương ứng cho từng trường. <strong>Mã môn học</strong> và <strong>Tên môn học</strong> là bắt buộc.
                        </div>
                        <div class="row g-3">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select column-mapping" data-field="name" data-required="true">
                                    <option value="">-- Chọn cột --</option>
                                </select>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Số tín chỉ</label>
                                <select class="form-select column-mapping" data-field="credit">
