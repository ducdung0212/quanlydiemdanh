...
@section('content')
    <div class="flex items-center flex-wrap justify-between gap20 mb-27">
        ...
        <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
            ...
            <li>
                <div class="text-tiny">Quản lý Môn Học</div>
            </li>
        </ul>
    </div>
    ...
    <div class="wg-box">
        <div class="flex items-center justify-between gap10 flex-wrap">
            ...
            <div class="d-flex gap10 align-items-center">
                ...
                <a class="tf-button style-1 w208" href="#" data-bs-toggle="modal" data-bs-target="#addSubjectModal">
...
@push('scripts')
    <script src="{{ asset('js/admin/subjects-index.js') }}"></script>
@endpush
