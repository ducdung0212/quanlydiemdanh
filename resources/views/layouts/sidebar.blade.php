    ...
    <div class="center">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('face-registration') }}" class="menu-item-button">
                            <div class="icon">
                                <img src="{{ asset('images/icon/registration.svg') }}" alt="Đăng ký khuôn mặt"
                                    class="svg-icon">
                            </div>
        ...
        @else
            ...
            <div class="center-item">
                ...
                <ul class="menu-list">
                    <li class="menu-item">
                        <a href="{{ route('lecturer.exam-schedules') }}" class="menu-item-button">
                            <div class="icon">
                                <img src="{{ asset('images/icon/exam_schedule.svg') }}" alt="Ca thi của bạn"
                                    class="svg-icon">
                            </div>
                            <div class="text">Ca thi của bạn</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('attendance') }}" class="menu-item-button">
                            <div class="icon">
                                <img src="{{ asset('images/icon/attendance.svg') }}" alt="Điểm danh"
                                    class="svg-icon">
                            </div>
